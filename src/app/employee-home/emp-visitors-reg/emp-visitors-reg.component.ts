...
@Component({
  selector: 'app-emp-visitors-reg',
  templateUrl: './emp-visitors-reg.component.html',
  styleUrls: ['./emp-visitors-reg.component.scss'],
})
export class EmpVisitorsRegComponent implements OnInit {
